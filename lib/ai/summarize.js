...
const SUMMARY_TOOL = {
  ...
  input_schema: {
    type: "object",
    required: ["tldr", "summary", "key_takeaways", "categories", "difficulty", "content_type", "topics"],
    properties: {
      tldr: {
        type: "string",
        description: "One sentence (max 20 words) capturing the core message or thesis",
      },
      summary: {
        type: "string",
      ...
      key_takeaways: {
        type: "array",
        items: { type: "string" },
        description: "List of key takeaways (3-7 items)",
      },
      actionable_advice: {
        type: "array",
        items: { type: "string" },
      ...
      difficulty: {
        ...
        description: "Difficulty or depth level of the content",
      },
      content_type: {
        type: "string",
      ...
      topics: {
        type: "array",
        items: { type: "string" },
        description: "3-6 free-form topic tags (e.g. 'habit stacking', 'cold exposure', 'compound interest'). Lowercase, specific, reusable across items.",
      },
      categories: {
        type: "array",
        items: {
...
- **tldr**: One punchy sentence (max 20 words) — the single core message someone should remember.
- **summary**: 2-3 paragraphs covering what the content is about, key arguments, and conclusions.
- **key_takeaways**: 3-7 bullet-point takeaways. Specific and actionable, not vague.
- **actionable_advice**: Concrete actions the viewer/reader can take today.
- **frameworks_and_analogies**: Mental models, frameworks, or memorable analogies used.
- **notable_quotes**: Direct quotes with speaker/timestamp attribution.
- **difficulty**: "beginner" (introductory), "intermediate" (assumes some knowledge), or "advanced" (deep/technical).
- **content_type**: The format — tutorial, opinion, research, interview, review, explainer, motivational, news, case-study, or other.
- **topics**: 3-6 lowercase, specific, reusable tags (e.g. "habit stacking", "zone 2 cardio", "prompt engineering"). These should be granular enough to connect related items across different domains.
